            ...
            <div className="2xl:fixed 2xl:max-w-3xl top-0 2xl:min-h-screen flex flex-col justify-center w-full p-10 sm:p-16">
                ...
                <div className="flex flex-col sm:flex-row space-y-8 sm:space-y-0 sm:space-x-10 items-start sm:items-center pt-16">
                    <a className="text-sm text-slate-400 font-medium flex flex-row items-center rounded-sm" target="_blank" href="https://github.com/lewwiss">
                        <svg className="h-6 w-6 mr-4" viewBox="0 0 256 249" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" fill="#a3a3a3">
                    ...
                    <a className="text-sm text-slate-400 font-medium flex flex-row items-center rounded-sm" target="_blank" href="mailto:lewiswinthrop27@gmail.com">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3.5" viewBox="0 0 20 20" fill="#a3a3a3">
