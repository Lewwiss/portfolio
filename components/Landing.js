    ...
    return (
        <div className="2xl:absolute w-full xl:min-h-screen flex flex-col justify-center">
            <div className="2xl:fixed 2xl:max-w-3xl top-0 min-h-screen flex flex-col justify-center w-full p-10 sm:p-16">
                ...
                <div className="flex flex-col sm:flex-row space-y-8 sm:space-y-0 sm:space-x-10 items-start sm:items-center pt-16">
                    <a className="text-sm text-neutral-500 font-medium flex flex-row items-center rounded-sm" target="_blank" href="https://github.com/lewwiss">
                        <svg class="h-6 w-6 mr-4" viewBox="0 0 256 249" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" fill="#737373">
                    ...
                    <a className="text-sm text-neutral-500 font-medium flex flex-row items-center rounded-sm" target="_blank" href="mailto:lewiswinthrop27@gmail.com">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3.5" viewBox="0 0 20 20" fill="#737373">
                            <path fill-rule="evenodd" d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm0 2h10v7h-2l-1 2H8l-1-2H5V5z" clip-rule="evenodd"></path>
                        </svg>
                        lewiswinthrop27@gmail.com
                    </a>
                </div>
            </div>
        </div>
