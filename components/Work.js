    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 space-y-6">
                ...
                <Project title="Next Contract Interactor (Eth)" desc="A next app that uses the alchemy web3 package to allow users to connect a web3 wallet such as Meta Mask, and interact with a ethereum smart contract." tags={["NextJS", "Web3", "Ethereum"]} link="https://github.com/Lewwiss/next-nft-minter" />
