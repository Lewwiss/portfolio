    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 space-y-6">
                <Project title="React Shopify Storefront" desc="This is a react app that uses the Shopify Buy SDK to allow users to import their products and create a custom storefront. This could also be used as a headless CMS." tags={["React", "Shopify", "E-Commerce"]} link="https://github.com/Lewwiss/react-storefront-template" />
                ...
                <Project title="React Design Showcase" desc="A very simple website to showcase my CSS and design skills. I've used tailwind as my styling library as I think it's the easiest to customize." tags={["Javascript", "React", "Tailwind"]} link="#" />
